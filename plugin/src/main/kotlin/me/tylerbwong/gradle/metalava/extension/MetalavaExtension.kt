...
public open class MetalavaExtension @Inject constructor(objectFactory: ObjectFactory) {
   ...
   * (e.g. @Composable)
   */
  public val apiCompatAnnotations: SetProperty<String> = objectFactory.setProperty()
   ...
   *
   * Using this as an input to a task will run the generate signature task and generate a signature
   * file.
   */
